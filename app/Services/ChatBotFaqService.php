...
final class ChatBotFaqService
{
    ...
    private const FAQS = [
        ...
        'manual_empaquetado' => [
            'keywords' => ['manual de empaque', 'manual de empaquetado', 'como empacar', 'guia de empaque', 'empaquetar producto'],
            'terms' => ['empaque', 'empaquetar', 'empacar', 'caja', 'sellado'],
            'audience' => ['seller'],
            'response' => "Lyrium tiene un Manual de Empaquetado oficial para vendedores. Resumen rápido:\n\n📦 *Cajas:* 7 tamaños (XXS a XL). Elige según peso y tamaño del producto, dejando 3-5cm de espacio para relleno.\n\n🛡️ *Protección:* Envuelve productos frágiles con burbujas (2 vueltas, burbujas hacia el producto). Usa relleno (chips o papel kraft). Haz la prueba del movimiento antes de cerrar.\n\n📸 *Foto obligatoria:* Toma foto cenital del interior antes de cerrar. Guarda 90 días.\n\n🏷️ *Sellado:* Patrón en H con cinta mínima de 5cm.\n\n📋 *Papeles:* Boleta/factura + packing list van encima del producto en bolsa plástica.\n\nEtiqueta siempre en la cara superior. Consulta el manual completo en lyriumbiomarketplace.com/manual-empaquetado 🌿",
        ],
        'tyc_cliente' => [
            'keywords' => ['terminos y condiciones', 'tyc cliente', 'politicas privacidad', 'privacidad datos', 'politica devoluciones lyrium'],
            'terms' => ['terminos', 'condiciones', 'privacidad', 'politicas'],
            'audience' => ['customer'],
            'response' => "Resumen de los Términos y Condiciones de Lyrium para clientes:\n\n🔒 *Privacidad:* Tus datos personales se usan solo para operaciones de compra-venta. Lyrium los almacena de forma segura.\n\n💳 *Pagos:* Solo pago en línea (Visa, Mastercard, Amex, Diners) por Izipay y Culqi. Lyrium no almacena datos de tarjeta.\n\n📦 *Envíos:* A nivel nacional, sujetos a políticas de cada vendedor.\n\n🔄 *Devoluciones:* Sujetas a las políticas de cada tienda vendedora.\n\n👤 *Cuenta:* No es obligatoria para comprar, pero da beneficios adicionales.\n\n📄 *Comprobantes:* Lyrium emite boleta o factura electrónica con validación SUNAT.\n\nConsultas el documento completo en lyriumbiomarketplace.com/terminos 🌿",
        ],
        'tyc_vendedor' => [
            'keywords' => ['terminos vendedor', 'tyc vendedor', 'contrato vendedor', 'obligaciones vendedor', 'politicas vendedor lyrium'],
            'terms' => ['terminos vendedor', 'obligaciones vendedor', 'contrato seller'],
            'audience' => ['seller'],
            'response' => "Resumen de los Términos y Condiciones de Lyrium para vendedores:\n\n📋 *Obligaciones:* Productos nuevos, información veraz, precios en soles con IGV, plazos de entrega, servicio post-venta.\n\n💰 *Comisión:* 15% sobre venta sin IGV. Comprobante emitido automáticamente.\n\n💳 *Pagos:* Cada lunes se revisan ventas de la semana anterior; pago en máximo 3 días hábiles (transferencia, Yape o Plin empresarial).\n\n📦 *Despacho:* El Seller coordina el envío. Debe usar medios adecuados de protección.\n\n⚖️ *Propiedad intelectual:* Productos deben ser legales y originales. Prohibidos los falsificados.\n\n📧 *Correo corporativo:* Se asigna un correo @lyriumbiomarketplace.com.\n\nConsultas el documento completo en lyriumbiomarketplace.com/terminos 🌿",
        ],
        'privacidad' => [
            'keywords' => ['datos personales', 'mis datos', 'proteccion datos', 'ley datos personales'],
            'terms' => ['datos personales', 'privacidad', 'proteccion datos'],
            'audience' => ['customer', 'seller'],
            'response' => 'Lyrium cumple con la Ley de Protección de Datos Personales del Perú (Ley N° 29733). Tus datos personales (nombres, documento, dirección, correo, teléfono) se usan exclusivamente para operaciones de compra-venta y se almacenan de forma segura y confidencial. Solo personal autorizado accede a ellos. No se comparte información personal con terceros sin tu consentimiento, excepto proveedores de envío y pago para cumplir con las entregas. Para más detalles, consulta nuestros Términos y Condiciones en lyriumbiomarketplace.com/terminos 🌿',
        ],
    ];
