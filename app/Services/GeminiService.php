...
final class GeminiService
{
    ...
    private function sellerKnowledge(): array
    {
        return [
            '— PLANES Y COMISIONES —',
            'Lyrium ofrece 3 planes de suscripción para vendedores. Todos cobran 15% de comisión por venta.',
            '',
            ...
            '',
            'Plan Crece (de pago):',
            '  · Precio mensual: S/. 40 (pago referencial). Descuentos por compromiso anual o mayor.',
            '  · Comisión: 15% por venta.',
