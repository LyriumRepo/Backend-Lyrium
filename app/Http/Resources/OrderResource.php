...
final class OrderResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'globalStatus' => trim($this->computeGlobalStatus()),
            'statusLabel' => $this->getStatusLabel(),
            'deliveredAt' => $this->delivered_at?->toIso8601String(),
            'customerValidatedAt' => $this->customer_validated_at?->toIso8601String(),
            'validationSource' => $this->validation_source,
            'paymentMethod' => $this->payment_method,
            'paymentStatus' => $this->payment_status,
            'paymentStatusLabel' => $this->payment_status_label,
            'totalQuantity' => $totalQty,
            'shippingType' => $this->shipping_type,
            'checkoutCarrier' => $this->carrier,
            ...
            'branch' => $this->whenLoaded('branch', fn () => [
                ...
                'hours' => $this->branch->hours,
                'mapsUrl' => $this->branch->maps_url,
            ]),
            'subtotal' => (float) $this->subtotal,
            'shippingCost' => (float) $this->shipping_cost,
            'storeShipping' => $this->store_shipping,
