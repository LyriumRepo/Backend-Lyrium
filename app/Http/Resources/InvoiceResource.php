...
final class InvoiceResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'customer_name' => $this->customer_name ?? $this->business_name ?? '',
            'customer_ruc' => $this->customer_ruc ?? $this->nit ?? '',
            ...
            'rapifac_pdf_url' => app(\App\Services\RapifacService::class)->getInvoicePdfUrl($this->provider_invoice_id),
