...
@section('email_title', 'El proveedor está en camino — Lyrium')
...
<table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:20px;">
  <tr>
    <td style="background:#eff6ff;border-left:4px solid #3b82f6;border-radius:0 8px 8px 0;padding:14px 16px;">
      <p style="margin:0;font-size:15px;font-weight:600;color:#1d4ed8;">🚗 ¡El proveedor está en camino!</p>
      <p style="margin:6px 0 0;font-size:14px;color:#374151;">
        El equipo de <strong>{{ $storeName }}</strong> ya se encuentra en camino para brindarte el servicio.
      </p>
    </td>
  </tr>
</table>
...
<p style="margin:0 0 20px;font-size:14px;color:#4b5563;line-height:1.6;">
  Por favor, asegúrate de estar disponible para recibir al equipo. Si necesitas coordinar, contáctalos a través del chat de Lyrium.
</p>
...
<p style="margin:0;font-size:12px;color:#9ca3af;text-align:center;">
  Gracias por confiar en Lyrium BioMarketplace 🌿
</p>
@endsection
