...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .summary-card { flex: 1; background: #f0f9f4; padding: 10px; border-radius: 6px; text-align: center; }
        .summary-card .label { font-size: 7px; text-transform: uppercase; letter-spacing: 1px; color: #2e6b50; }
        .summary-card .value { font-size: 14px; font-weight: bold; color: #1a3a2e; margin-top: 4px; }
